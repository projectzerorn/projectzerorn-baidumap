    ...
    private BitmapDescriptor getMarkView(String title, String mBackgroundType) {//获取自定义的markview
        if (mBackgroundType != null && mBackgroundType.length() > 0) {
            ...
            if (mBackgroundType.equalsIgnoreCase("MarkRed")) {
                ...
                tv.setVisibility(View.GONE);
            } else if (mBackgroundType.equalsIgnoreCase("MarkWX")) {
                view.setBackgroundResource(R.drawable.mark_wx);
                tv.setVisibility(View.GONE);
            } else if (mBackgroundType.equalsIgnoreCase("MarkYX")) {
                view.setBackgroundResource(R.drawable.mark_yx);
                tv.setVisibility(View.GONE);
            }else if (mBackgroundType.equalsIgnoreCase("MarkSELF")) {
                view.setBackgroundResource(R.drawable.mark_self);
                tv.setVisibility(View.GONE);

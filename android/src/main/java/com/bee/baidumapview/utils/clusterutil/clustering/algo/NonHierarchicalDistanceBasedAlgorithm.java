...
package com.bee.baidumapview.utils.clusterutil.clustering.algo;
...
import com.bee.baidumapview.utils.clusterutil.projection.Bounds;
...
import com.bee.baidumapview.utils.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.bee.baidumapview.utils.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.bee.baidumapview.utils.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.bee.baidumapview.utils.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.bee.baidumapview.utils.clusterutil.clustering.algo

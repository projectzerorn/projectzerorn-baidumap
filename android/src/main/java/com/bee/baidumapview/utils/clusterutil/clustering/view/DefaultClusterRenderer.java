...
package com.bee.baidumapview.utils.clusterutil.clustering.view;
...
import com.bee.baidumapview.utils.clusterutil.MarkerManager;
import com.bee.baidumapview.utils.clusterutil.clustering.Cluster;
...
import com.bee.baidumapview.utils.clusterutil.projection.Point;
import com.bee.baidumapview.utils.clusterutil.projection.SphericalMercatorProjection;
import com.bee.baidumapview.utils.clusterutil.ui.IconGenerator;
...
import static com.bee.baidumapview.utils.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.bee.baidumapview.utils.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private com.bee.baidumapview.utils.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        com.bee.baidumapview.utils.clusterutil.ui.SquareTextView squareTextView =
                new com.bee.baidumapview.utils.clusterutil.ui.SquareTextView(context);
